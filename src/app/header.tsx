    ...
    <li className="px-4">
      <Link
        ...
        className={clsx(
          ...
          'text-slate-200 hover:text-white hover:drop-shadow shadow-white transition-all whitespace-nowrap',
...
export const Header = () => (
  <header className="sticky top-0 w-full ">
    <nav className="bg-gray-600 shadow-lg">
      <ul className={`flex items-center overflow-x-scroll md:overflow-x-hidden ${styles.scrollbar}`}>
